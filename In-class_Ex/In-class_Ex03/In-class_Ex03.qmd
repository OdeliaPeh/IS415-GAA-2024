...
Always start with package installation! ALWAYS include tidyverse
...
```{r}
pacman::p_load(sf, raster, spatstat, tmap, maptools, tidyverse, sp, rgdal, spNetwork)
```
...
The rest of in class exercise 3 can be found in Hands on exercise 3.
