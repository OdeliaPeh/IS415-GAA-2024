...
Notice that the distribution of quantile data classification method are more evenly distributed then equal data classification method. Different data classifiction types are better for different types of maps.
