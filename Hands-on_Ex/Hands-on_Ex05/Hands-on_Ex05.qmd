...
According to the exercise, we will learn how to compute Global Measures of Spatial Autocorrelation (GMSA) by using **spdep** package. By the end to this hands-on exercise, you will be able to:
...
As is the norm, we need to import the necessary R packages for use. The following R packages will be used for this exercise:
...
# Autocorrelation: the questions

## Global autocorrelation (as taken from the website)
...
## Local autocorrelation (as taken from the website)
...
## Data wrangling: relational join
